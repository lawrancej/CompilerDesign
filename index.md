...
A language generated by context-free grammar.

### What is a context-free grammar?

### What is the difference between a regular language and a context free language?

A regular language is made up of formal regular expressions, and can be accepted by deterministic and non-deterministic finite state machines. Regular languages also do not accept arbitrary nesting, like recursion.
A context-free language uses expressions where the left-hand side is a single "non-terminal" symbol.
